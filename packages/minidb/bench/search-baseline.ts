...
//
// "Without minidb" search baseline over the SAME real ~/.cloud-code sessions
...
//
// Run:  node --import tsx bench/search-baseline.ts [--data ~/.cloud-code]
...
const DATA = path.resolve(arg('data', path.join(os.homedir(), '.cloud-code')));
