...
const workspacePackages = new Map([
  ['@cloud-code/agent-core', 'agent-core'],
  ['@cloud-code/kaos', 'kaos'],
  ['@cloud-code/oauth', 'oauth'],
  ['@cloud-code/kosong', 'kosong'],
  ['@cloud-code/protocol', 'protocol'],
]);
  ...
  await Promise.all(
    files.map(async (file) => {
      ...
      const updated = providerClientText.replaceAll(
        /(["'])(#\/[^"']+|@cloud-code\/(?:agent-core|kaos|oauth|kosong|protocol)(?:\/[^"']+)?)\1/g,
