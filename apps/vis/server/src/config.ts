...
/** Resolve CLOUD_CODE_HOME (env > ~/.cloud-code). */
export function resolveCloudCodeHome(): string {
  const envHome = process.env['CLOUD_CODE_HOME'];
...
export const CLOUD_CODE_HOME: string = resolveCloudCodeHome();
