 ...
 *
 * Run:
 *   pnpm --filter cloudcode-cli exec vitest bench test/tui/tui-frame.bench.ts
 */

import type { Component, Terminal } from '@cloud-code/pi-tui';
import { TUI } from '@cloud-code/pi-tui';
