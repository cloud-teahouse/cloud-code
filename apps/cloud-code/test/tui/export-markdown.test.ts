...
import type { ContentPart, ToolCall } from '@cloud-code/sdk';
import type { ContextMessage, PromptOrigin } from '@cloud-code/sdk';
...
describe('buildExportMarkdown', () => {
  ...
  it('builds complete markdown with frontmatter and overview', () => {
    ...
    expect(md).toContain('# Cloud Code CLI Session Export');
