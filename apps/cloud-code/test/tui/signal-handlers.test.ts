...
function makeDriver(): { driver: SignalDriver; tui: CloudCodeTUI } {
  const tui = new CloudCodeTUI(makeHarness() as never, makeStartupInput());
...
describe('CloudCodeTUI signal handlers', () => {
