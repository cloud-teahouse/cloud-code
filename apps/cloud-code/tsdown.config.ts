...
export default defineConfig({
  ...
  deps: {
    onlyBundle: false,
    // Wasm assets resolve from node_modules at runtime
    // (agent-core src/tools/support/shell-ast/parser.ts) — keep the packages
    // external; they are declared as dependencies of this package.
