import type { AutocompleteItem, SlashCommand } from '@cloud-code/pi-tui';
import type { FlagId } from '@cloud-code/sdk';

export type SlashCommandAvailability = 'always' | 'idle-only';

export interface CloudCodeSlashCommand<Name extends string = string> extends SlashCommand {
  readonly name: Name;
