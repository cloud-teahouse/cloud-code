...
import { OAUTH_LOGIN_REQUIRED_STARTUP_NOTICE } from '../constant/cloud-code-tui';
...
import type { AppState, CloudCodeTUIOptions } from '../types';
...
export class AuthFlowController {
  ...
  enterLoginRequiredStartupState(): void {
    ...
    this.host.appendStartupNotice(resolveDescription(OAUTH_LOGIN_REQUIRED_STARTUP_NOTICE));
