...
export function registerExportCommand(parent: Command, deps?: Partial<ExportDeps>): void {
  parent
    ...
    .option(
      ...
      'Skip bundling the active global diagnostic log (~/.cloud-code/logs/cloud-code.log, not rotated .1 files). By default the global log is included.',
    )
